          ...
          jsonLd={[
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { '@type': 'ListItem', position: 2, name: 'Bambole', item: 'https://lovehuble.com/prodotti/bambole' },
                { '@type': 'ListItem', position: 3, name: initialProduct.name, item: `https://lovehuble.com/prodotti/bambole/${initialProduct.slug}` },
              ],
            },
          ]}
        />
